...
class Command:
    ...
    def __init__(self):
        ...
        try:
            ...
            parser.add_argument('--port', help="Custom port (Default 80) ", type=int)
            ...
            parser.add_argument('-c', '--check', help="Directory scan eg --check=directories or subdomains "
                                                      "--check=subdomains (directories by default)")
