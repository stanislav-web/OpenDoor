...
- (enhancement) add NemesidaWAF custom and handle custom`222` block responses without scan aborts, including status/header/body-based WAF fingerprinting and safe fallback classification.
