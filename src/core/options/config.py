...
class Config:
    ...
    arguments = [{"group": "request", "args": "-p", "argl": "--port", "default": 80, "action": "store",
        ...
        {"group": "request", "args": None, "argl": "--accept-cookies", "default": False, "action": "store_true",
            "help": "Accept and route cookies from responses", "type": bool},
