...
class Browser(Filter):
    ...
    def __export_session_params(self):
        ...
        params = {
            ...
            'client_cert': getattr(self.__config, 'client_cert', None),
            'client_key': getattr(self.__config, 'client_key', None),
            'client_key_password_env': getattr(self.__config, 'client_key_password_env', None),
