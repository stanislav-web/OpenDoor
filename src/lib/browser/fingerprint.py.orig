...
class Fingerprint(object):
    ...
    def _apply_detection_rules(
        ...
        # MODX
        modx_header_hint = 'modx' in x_powered_by
        modx_hint = (
        ...
        if modx_header_hint:
            self._add_signal('MODX', self.CMS_CATEGORY, 'header', 'x-powered-by={0}'.format(headers.get('x-powered-by')), 8)
