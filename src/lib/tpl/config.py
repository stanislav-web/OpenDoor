...
class Config(object):
    ...
    templates = {
        ...
        'stop_threads': 'Pausing workers ({threads}). Active requests may finish first...',
        'option_prompt': 'Scan paused. Press Enter/[C] to continue or [E]/[Q] to abort scan: ',
        'resume_threads': 'Resuming scan...',
        'unknown_pause_command': 'Unknown command. Use Enter/C to continue or E/Q to abort scan.',
        ...
        'waf_guard_enabled': 'WAF guard enabled: after={after}, threshold={threshold}%',
        'waf_guard_triggered': 'WAF guard triggered: block ratio is {ratio}% after {classified} classified responses. Stopping scan.',
