...
| [Mastering OpenDoor](guides/mastering-opendoor.md) | Hands-on article series companion with stable commands and lab setup. |
| [Installation and update](Installation-and-update.md) | Install and update with Homebrew, Chocolatey, pipx, pip, Docker, Linux packages, or source checkouts. |
