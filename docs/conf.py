...
#
html_title = u'OWASP WEB Directory Scanner v4.0.1-beta'
...
# of the sidebar.
#
html_logo = 'images/open-door.png'
...
htmlhelp_basename = 'OWASPWEBDirectoryScannerdoc'
...
man_pages = [
    (master_doc, 'owaspwebdirectoryscanner', u'OWASP WEB Directory Scanner Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OWASPWEBDirectoryScanner', u'OWASP WEB Directory Scanner Documentation',
     author, 'OWASPWEBDirectoryScanner', 'One line description of project.',
     'Miscellaneous'),
]
